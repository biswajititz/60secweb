...
export function Footer() {
  return (
    <footer className=" text-background py-8 bg-gray-300 container  mx-auto  rounded-4xl my-10">
      <div className=" ">
        <div className="flex flex-col justify-center items-center text-center px-6 ">
          ...
          {cols.map((c) => (
            <div key={c.title} className="flex flex-row gap-6 md:gap-8 mt-8  items-center ">
              <h4 className="font-display text-sm font-semibold uppercase tracking-wider text-blue-950">
                {c.title}
              </h4>

              <ul className=" space-y-2.5 text-sm text-black flex flex-row gap-6">
                {c.links.map((link) => (
        ...
        <div className="mt-8 flex flex-col items-center justify-between gap-4 border-t border-t-[#bcc0c7] pt-6 text-sm text-black md:flex-row px-6">
